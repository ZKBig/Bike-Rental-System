...
import com.victor.BikeRentalDialog.DailyRentPanel;
import com.victor.BikeRentalDialog.HourlyRentPanel;
import com.victor.BikeRentalDialog.PaymentDialog;
import com.victor.BikeRentalDialog.RentalLeftMenuCellRenderer;
import com.victor.BikeRentalDialog.WeeklyRentPanel;
...
/**
 * 
 * @Description the dialog of the family rental
 * @author Victor Wang Email:1779408741@qq.com
 * @version
 * @date 2020年11月23日下午6:52:00
 *
 */
public class FamilyRentalDialog extends JDialog{

	private static final long serialVersionUID = -6739784893215178235L;
	...
	public FamilyRentalDialog(JFrame owner, BikeInfo[] bikes, LoginFrame frame, UserInfo user,
			BikeRentalPanel bikePanel, BikeReturnPanel bikeReturn) {
		super(owner, "Family Rental", true);
	...
	/**
	 * 
	 * @Description update the status of the bike
	 * @author Victor
	 * @date 2020年12月5日上午10:28:332020年12月5日
	 *
	 */
	...
	/**
	 * 
	 * @Description add the rental bikes to the user information
	 * @author Victor
	 * @date 2020年12月5日上午10:28:492020年12月5日
	 *
	 */
	 ...
	 * @Description
	 * @author Victor
	 * @date 2020年11月24日下午12:55:512020年11月24日
	 *
	 */
	private void initialBottomPanel() {
		...
		button.setLength(10);
		button.setBounds(button.getBounds().x, button.getBounds().y, button.getBounds().width,
				button.getBounds().height + 10);
			...
			if (isSelectionValid()) {
				...
				if (bikes.length == 1) {
					select = JOptionPane.showConfirmDialog(this,
							"Do you comfirm to rent " + String.valueOf(bikes.length) + " bike with the rent being "
									+ String.valueOf(totalRent) + "RMB");
				} else {
					select = JOptionPane.showConfirmDialog(this,
							"Do you comfirm to rent " + String.valueOf(bikes.length) + " bikes with the rent being "
									+ String.valueOf(totalRent) + "RMB");
				}
	 ...
	 * @author Victor
	 * @date 2020年11月30日下午8:06:052020年11月30日
	 *
	 */
	public void getRentalMoney() {
		if (leftMenu.getSelectedIndex() == 0) {
			totalRent = (int) ((Integer.parseInt(hourly.getHourlyRentPanel().getEndTime().substring(0,
							hourly.getHourlyRentPanel().getEndTime().indexOf(':')))
					- Integer.parseInt(hourly.getHourlyRentPanel().getStartTime().substring(0,
							hourly.getHourlyRentPanel().getStartTime().indexOf(':'))))
					* 50 * bikes.length * 0.7);
		} else if (leftMenu.getSelectedIndex() == 1) {
			if (Integer.parseInt(daily.getDailyRentPanel().getYear()) == Integer
				...
				if (Integer.parseInt(daily.getDailyRentPanel().getMonth()) == Integer
					...
					totalRent = (int) ((Double.parseDouble(daily.getDailyRentPanel().getDay1())
							- Double.parseDouble(daily.getDailyRentPanel().getDay())) * 200 * bikes.length * 0.7);
				} else {
					...
					if (((year % 4 == 0) && (year % 100 != 0)) || (year % 400 == 0)) {
						...
						totalRent = (int) (tempNumber * 200 * bikes.length * 0.7);
					} else {
			...
			if (Integer.parseInt(weekly.getWeeklyRentPanel().getYear()) == Integer
				...
				if (Integer.parseInt(weekly.getWeeklyRentPanel().getMonth()) == Integer
					...
					totalRent = (int)(((Integer.parseInt(weekly.getWeeklyRentPanel().getDay1())
							- Integer.parseInt(weekly.getWeeklyRentPanel().getDay()))/7)* 600 * bikes.length * 0.7);
				} else {
					...
					if (((year % 4 == 0) && (year % 100 != 0)) || (year % 400 == 0)) {
						...
						tempNumber = tempNumber + day1;
						totalRent = (int) ((tempNumber / 7) * 600 * bikes.length * 0.7);
					} else {
						tempNumber = daysNumber1[month - 1] - day;
						for (int i = month; i < month1-1; i++) {
							tempNumber = daysNumber1[i] + tempNumber;
	 ...
	 * @author Victor
	 * @date 2020年11月30日下午6:50:422020年11月30日
	 *
	 */
	 ...
	 * @Description
	 * @author Victor
	 * @date 2020年11月26日下午2:56:532020年11月26日
	 *
	 */
	 ...
	 * @author Victor
	 * @date 2020年11月24日下午12:37:392020年11月24日
	 *
	 */
	 ...
	 * @author Victor
	 * @date 2020年11月24日下午12:37:362020年11月24日
	 *
	 */
	 ...
	 * @author Victor
	 * @date 2020年11月24日下午12:24:342020年11月24日
	 *
	 */
